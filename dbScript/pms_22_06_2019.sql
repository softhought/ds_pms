...
CREATE TABLE `antenantal_master` (
  ...
  `usg_week` int(10) DEFAULT NULL,
  `usg_days` int(10) DEFAULT NULL,
  `usg_date` datetime DEFAULT NULL,
  `parity_term_delivery` int(10) DEFAULT NULL COMMENT 'Obstetrics History',
  `parity_preterm` int(10) DEFAULT NULL COMMENT 'Obstetrics History',
  `parity_abortion` int(10) DEFAULT NULL COMMENT 'Obstetrics History',
  `parity_issue` int(10) DEFAULT NULL COMMENT 'Obstetrics History',
  `gravida_parity` int(10) DEFAULT NULL COMMENT 'Obstetrics History',
  `spontaneous_abortion` int(10) DEFAULT NULL COMMENT 'Obstetrics History',
...
insert  into `antenantal_master`(`antenantal_id`,`case_master_id`,`wife_bloodgroup`,`husband_bloodgroup`,`wife_occupation`,`husband_occupation`,`wife_education`,`husband_education`,`married_for_year`,`trying_for_year`,`medicine_concieve`,`procedure_concieve`,`procedure_date`,`cigarette_addiction`,`cigarette_per_day`,`alcohol_addiction`,`other_addiction`,`lmp_date`,`edd_date`,`usg_week`,`usg_days`,`usg_date`,`parity_term_delivery`,`parity_preterm`,`parity_abortion`,`parity_issue`,`gravida_parity`,`spontaneous_abortion`,`menstrual_cycle_type`,`menstrual_flow`,`menstrual_duration_days`,`menstrual_cycle_days`,`diseases_ids`,`is_other_diseases`,`other_diseases`,`any_allergy`,`vaccination_ids`,`highrisk_ids`,`is_highrisk_others`,`highrisk_others`) values (5,4,7,5,4,2,1,4,'7','5','Clomiphene,Gonadotropins','IUI,IVF->FET,ET','2020-07-22 00:00:00','No','12','Never','','2019-01-02 00:00:00','2019-09-18 00:00:00',0,0,'2019-09-19 00:00:00',4,5,6,7,52,6,'Regular','','10','20','6,7,8','N',NULL,'skin problem','1,5','1,2,5','Y','other high risk'),(13,5,0,0,0,0,0,0,'0','0','','',NULL,'','','','',NULL,NULL,0,0,NULL,0,0,0,0,0,0,'','','','','','N',NULL,'','','','N',''),(14,3,0,0,0,0,0,0,'0','0','','',NULL,'','','','',NULL,NULL,0,0,NULL,0,0,0,0,0,0,'','','','','','N',NULL,'','','','N',''),(15,15,0,0,0,0,0,0,'0','0','','',NULL,'','','','',NULL,NULL,0,0,NULL,0,0,0,0,0,0,'','','','','','N',NULL,'','','','N',''),(16,16,5,0,0,0,1,0,'0','0','Clomiphene','',NULL,'','','','',NULL,NULL,0,0,NULL,0,0,0,0,0,0,'','','','','','N',NULL,'','','','N','');
...
insert  into `case_master`(`case_id`,`case_no`,`patient_id`,`clinic_id`,`major_group`,`created_on`,`patient_reg_type`,`previous_case_id`) values (1,'ILS/00016/19',12,1,'Obstetrics','2019-05-30 00:00:00',NULL,NULL),(2,'ILS/00017/19',13,1,'Obstetrics','2019-05-30 00:00:00',NULL,NULL),(3,'ILS/00018/19',14,1,'Obstetrics','2019-05-30 00:00:00',NULL,NULL),(4,'ILS/00019/19',15,1,'Obstetrics','2019-05-30 00:00:00',NULL,NULL),(5,'ILS/00020/19',16,1,'Obstetrics','2019-06-10 00:00:00',NULL,NULL),(15,'ILS/00031/19',20,1,'Obstetrics','2019-06-11 00:00:00','New',NULL),(16,'ILS/00032/19',21,1,'Obstetrics','2019-06-19 00:00:00','New',NULL);
...
insert  into `medicine_master`(`medicine_id`,`medicine_name`,`medicine_type`,`brand_name`,`generic`,`is_active`) values (1,'Pan-D',2,NULL,NULL,'Y'),(2,'ACCLUDUS - P',2,NULL,NULL,'Y'),(3,'CPZ 50',2,NULL,NULL,'Y');
...
insert  into `menstrual_medecine_details`(`id`,`medicine_name`,`medicine_duration`,`case_master_id`,`created_on`) values (309,'av','',16,'2019-06-19 00:00:00'),(326,'xyz','',4,'2019-06-22 00:00:00'),(327,'sds','',4,'2019-06-22 00:00:00');
...
insert  into `patient_master`(`patient_id`,`reg_date`,`selfmobile`,`alternate_mobile`,`patientname`,`patientage`,`patientgender`,`bloodgroup`,`created_on`,`last_modified`,`husband_bloodgroup`,`address`) values (12,'2019-05-30 00:00:00','9874566512','','Rahul Ghosh','2',2,5,'2019-05-30 15:39:10','2019-06-10 11:23:17',NULL,NULL),(13,'2019-05-30 00:00:00','2','2','Ravi Teja','2',2,2,'2019-05-30 15:50:47','2019-06-10 13:07:15',NULL,NULL),(14,'2019-05-30 00:00:00','2','2','Amit Roy','2',2,2,'2019-05-30 15:51:13',NULL,NULL,NULL),(15,'2019-05-30 00:00:00','91535758029','91535758030','Rani Paul','38',2,5,'2019-05-30 15:52:29','2019-06-15 19:06:28',7,'2/E,4th Floor,Raktima Apartment ,Kolkata, West Bengal - 700052'),(16,'2019-06-10 00:00:00','9153588888','','Riya','25',2,7,'2019-06-10 11:24:11','2019-06-11 16:29:28',NULL,NULL),(20,'2019-06-11 00:00:00','11','1','q','2',2,9,'2019-06-11 16:39:09',NULL,NULL,NULL),(21,'2019-06-19 00:00:00','9988774455','','A Ghosh','29',2,5,'2019-06-19 13:32:50',NULL,5,'a');
...
CREATE TABLE `previous_child_birth_history` (
  ...
  `babyage` decimal(10,2) DEFAULT NULL,
  `created_on` datetime DEFAULT NULL,
...
insert  into `previous_child_birth_history`(`child_dtl_id`,`case_master_id`,`birthplace`,`year`,`complication`,`medicalproblem`,`is_othermedprob`,`medicalproblem_other`,`delevery_type`,`babygender`,`babyage`,`created_on`) values (498,4,'kolkata','1990','4,5,6,7','1,2,6','Y','','CS',1,'2.00','2019-06-22 11:57:24'),(499,4,'Howrah','1994','7,10,11','5','N',NULL,'ND',2,'20.00','2019-06-22 11:57:24'),(500,4,'fd','1996','4,8','6','Y','sasafdg,essfrs','CS',1,'20.00','2019-06-22 11:57:24');
...
CREATE TABLE `regular_medicines_details` (
  ...
  `for_year` int(10) DEFAULT NULL,
  `for_month` int(10) DEFAULT NULL,
  PRIMARY KEY (`regular_medicines_dtl_id`)
) ENGINE=InnoDB AUTO_INCREMENT=236 DEFAULT CHARSET=utf8;

/*Data for the table `regular_medicines_details` */

insert  into `regular_medicines_details`(`regular_medicines_dtl_id`,`case_master_id`,`medicine_name`,`medicine_dose`,`for_year`,`for_month`) values (234,4,'Pan D','2',9,11),(235,4,'Sfsg','ewt',5,8);
...
insert  into `serial_master`(`id`,`next_serial_no`,`type`,`year`,`clinic_id`) values (4,'33','NEWCASE',2019,1),(5,'1','NEWCASE',2019,8),(6,'1','NEWCASE',2020,8),(7,'1','NEWCASE',2021,8),(8,'1','NEWCASE',2022,8),(9,'1','NEWCASE',2023,8);
