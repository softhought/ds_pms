    ...
    public function getSurgeryDetails($case_master_id)
    {
     $data = [];
         ...
         //created at 24-09-2019
           ...
           // $query = $this->db->select("*")
           //          ->from('surgery_master')
           //          ->join('surgery_details',"surgery_master.surgery_id=surgery_details.surgery_mst_id and surgery_details.case_master_id='".$case_master_id."' and surgery_master.is_active='Y'",'INNER')
           //          ->get();         
                #q();
                if($query->num_rows()> 0)
                {
