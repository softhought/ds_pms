		    ...
		    <h2 class="text-center">Login Now</h2>
                    ...
                    <form class="login-form" name="loginfrm" method="post" action="<?php echo(base_url());?>Login/check_login">
                      <div class="form-group" style="display: block">
                        ...
                        <label for="school" class="text-uppercase">Clinic</label>
                        <select class="form-control" name="clinic_id" id="clinic_id">
                          <option value="">Select</option> 
                          <?php
                         
                        
                         foreach ($cliniclist as $cliniclist) { ?>
                           <option value="<?php echo $cliniclist->clinic_id; ?>"><?php echo $cliniclist->clinic_name; ?></option>
                             
                       <?php  }
                        ?>   
                                                                          
                        </select>
                        <?php echo form_error('clinic_id'); ?>
