...
?>
		<tr id="rowPrescriptionInvestigationpanel_<?php echo $invDatarow['rowno']; ?>" class="row clearfix">

        <td style="width: 10%;font-size: 16px;"> 
	    <input type="hidden" class="presinvestigationIDPanelCls" name="presinvestigationPanelID[]" id="presinvestigationPanelID_<?php echo $invDatarow['rowno']; ?>" value="<?php echo $invDatarow['panelID']?>">
