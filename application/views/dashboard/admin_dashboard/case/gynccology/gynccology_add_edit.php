                                 ...
                                 <div class="row clearfix stageStepSection"><!-- start of trearment stage -->
                                   ...
                                   <div class="col-sm-2 leftmenuPatientCase">
                                    ...
                                    <button type="button" class="btn btn-block btn-xs waves-effect tab_lf_btn" id="antenantal_left_tab_menu_1"><span><i class="material-icons">assignment_ind</i></span>&nbsp;Patient Info</button>
                                     <button type="button" class="btn btn-block btn-xs waves-effect tab_lf_btn changecss"  id="antenantal_left_tab_menu_4"><span><i class="material-icons">receipt</i></span>Basic Info</button>
                        ...
                        <select name="year[]" id="year_<?php echo $i; ?>" class="form-control show-tick obsthist ischangechiefcomplaint"  data-live-search="true" tabindex="-98" <?php if($isDatachiefcomplaint == 'Y'){ if($bodycontent['chiefcomplaintsdetails'][$j]->is_check == 'N'){ ?> disabled <?php } } else{ ?> disabled <?php } ?> >
                            ...
                            <?php  
                                foreach ($bodycontent['Onetotwentydropdown'] as $Onetotwentydropdown) { ?>
                                      ...
                                      <option <?php if($isDatachiefcomplaint == 'Y'){ if($bodycontent['chiefcomplaintsdetails'][$j]->year == $Onetotwentydropdown){ ?> selected <?php } } ?> value="<?php echo $Onetotwentydropdown; ?>"><?php echo $Onetotwentydropdown; ?></option>
                                 <?php   } ?>
                 ...
                 <?php if(!empty($bodycontent['AllpainLowerData'])){ $painEditdata = 'Y'; }else{ $painEditdata = 'N'; } ?>
                  ...
                  <div class="row clearfix">
                       ...
                       <div class="col-sm-3">
                        <div class="form-group form-float">
                         <div class="form-line">
                           <input type="text" class="form-control paindata" name="pain_duration_years" id="pain_duration_years" autocomplete="off" value="<?php if($painEditdata == 'Y'){ echo($bodycontent['AllpainLowerData']->duration_years); } ?>" >
                               <label class="form-label">Years</label>
                            </div>
                       ...
                       <div class="col-sm-3">
                        <div class="form-group form-float">
                         <div class="form-line">
                           <input type="text" class="form-control paindata" name="pain_duration_months" id="pain_duration_months" autocomplete="off" value="<?php if($painEditdata == 'Y'){ echo($bodycontent['AllpainLowerData']->duration_months); } ?>" >
                               <label class="form-label">Months</label>
                            </div>
                        ...
                        <div class="form-group form-float" >
                         <div class="form-line">
                           <input type="text" class="form-control paindata" name="pain_duration_days" id="pain_duration_days" autocomplete="off" value="<?php if($painEditdata == 'Y'){ echo($bodycontent['AllpainLowerData']->duration_days); } ?>" >
                               <label class="form-label">Days</label>
                            </div>
                 ...
                 <div class="panel-body">
                   <div class="row clearfix">
                  	 <div class="col-sm-3">
                        ...
                        <div class="form-group form-float" >
                         <div class="form-line">
                           <input type="text" class="form-control paindata" name="discharge_duration_months" id="discharge_duration_months" autocomplete="off" value="<?php if($isWhiteDischarge == 'Y'){ echo $bodycontent['AllWhiteDischargeData']->duration_months;   } ?>" >
                               <label class="form-label">Months</label>
                            </div>
                        ...
                        <div class="form-group form-float" >
                         <div class="form-line">
                           <input type="text" class="form-control paindata" name="discharge_duration_days" id="discharge_duration_days" autocomplete="off" value="<?php if($isWhiteDischarge == 'Y'){ echo $bodycontent['AllWhiteDischargeData']->duration_days;   } ?>" >
                               <label class="form-label">Days</label>
                            </div>
                  ...
                  <div class="row clearfix">
                   ...
                   <div class="col-sm-3">
                     <div class="form-group form-float">
                         <div class="input-group">
                        <!--  <label class="form-label selectlabel zindex3">Frequency Of Micturition</label> -->
                         <select name="wants_termination" id="wants_termination" class="form-control show-tick paindata"  data-live-search="true" tabindex="-98">
                         <option value=""> &nbsp; </option> 
                         <?php 
                         ...
                         <?php if($isUnwantedPregnancy == 'Y'){ if($bodycontent['AllUnwantedPregnancyData']->wants_termination == $unwantedPregnancyTermination){ ?> selected <?php } } ?>
            ...
            <div class="panel panel-col-teal" id="complaint_10" style="<?php echo $displaynone; ?>">
                ...
                <div class="col-sm-3">
                      ...
                      <div class="form-group form-float">
                          ...
                          <label class="form-label selectlabel zindex3">Lt Ovary-Size < 9</label>
                    ...
                    <div class="col-sm-3">
                      <div class="form-group form-float">
                          ...
                          <label class="form-label selectlabel zindex3">RT.Overay-Size < 9</label>
                  ...
                  <div class="form-group form-group">
                 	...
                 	<div class="row clearfix">
                 		 <div class="col-sm-3">
                            ...
                            <label>Endometrial Thickness:</label>
                 ...
                 <div class="panel-body">
                  ...
                  <div class="row clearfix">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group form-float" >
                         <div class="form-line">
                           <input type="text" class="form-control" name="somthing_duration_years" id="somthing_duration_years" autocomplete="off" value="<?php if($isSomthingCommingdown == 'Y'){ echo $bodycontent['AllSomthingCommingdownData']->duration_years; } ?>" >
                               <label class="form-label">Years</label>
                            </div>
                        ...
                        <div class="form-group form-float" >
                         <div class="form-line">
                           <input type="text" class="form-control" name="somthing_duration_months" id="somthing_duration_months" autocomplete="off" value="<?php if($isSomthingCommingdown == 'Y'){ echo $bodycontent['AllSomthingCommingdownData']->duration_months; } ?>" >
                               <label class="form-label">Months</label>
                            </div>
                 ...
                 <div class="panel-body">
                  ...
                  <div class="row clearfix">
                   ...
                   <div class="col-sm-3">
                     ...
                     <div class="form-group form-float">
                         <div class="input-group ">
                         <label class="form-label selectlabel zindex3">Bleeding</label>
                   ...
                   <div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                      <div class="form-group form-float">
                         ...
                         <input type="text" class="form-control"  name="urinary_incontinence_years" id="urinary_incontinence_years" placeholder="" autocomplete="off" value="<?php if($isUrinaryIn == 'Y'){ echo $bodycontent['AllUrinaryIncontinenceData']->urinary_incontinence_years;  } ?>">  
                        </div>
                    ...
                    <div class="col-sm-3">
                      <div class="form-group form-float">
                         ...
                         <input type="text" class="form-control"  name="urinary_incontinence_months" id="urinary_incontinence_months" placeholder="" autocomplete="off" value="<?php if($isUrinaryIn == 'Y'){ echo $bodycontent['AllUrinaryIncontinenceData']->urinary_incontinence_months;  } ?>">  
                        </div>
                     ...
                     <div class="col-sm-3">
                      <div class="form-group form-float">
                         ...
                         <input type="text" class="form-control"  name="urinary_incontinence_days" id="urinary_incontinence_days" placeholder="" autocomplete="off" value="<?php if($isUrinaryIn == 'Y'){ echo $bodycontent['AllUrinaryIncontinenceData']->urinary_incontinence_days;  } ?>">  
                        </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-sm-3">
                     ...
                     <div class="form-group form-float">
                         ...
                         <?php if($isUrinaryIn == 'Y'){ if($bodycontent['AllUrinaryIncontinenceData']->urinary_episode == $postMenopausalAllEpisode){ ?> selected <?php } } ?>                                                                              
                    ...
                    <div class="col-sm-3">
                      <div class="form-group form-float">
                         ...
                         <label class="form-label selectlabel zindex3">Epiosode Years</label>
                     ...
                     <div class="col-sm-3">
                      <div class="form-group form-float">
                         ...
                         <label class="form-label selectlabel zindex3">Epiosode Months</label>
                 ...
                 <div class="panel-body">
                  ...
                  <div class="row clearfix">
                   <div class="col-sm-3">
                      ...
                      <div class="form-group form-float">
                         ...
                         <label class="form-label selectlabel zindex3">Years</label>
                         <input type="text" class="form-control"  name="lump_lower_years" id="lump_lower_years" placeholder="" autocomplete="off" value="<?php if($isLumplower == 'Y'){ echo $bodycontent['AllLumplowerAbdomenData']->lump_lower_years;  } ?>">  
                        </div>
                    ...
                    <div class="col-sm-3">
                      <div class="form-group form-float">
                         ...
                         <label class="form-label selectlabel zindex3">Months</label>
                         <input type="text" class="form-control"  name="lump_lower_months" id="lump_lower_months" placeholder="" autocomplete="off" value="<?php if($isLumplower == 'Y'){ echo $bodycontent['AllLumplowerAbdomenData']->lump_lower_months;  } ?>">  
                        </div>
                      ...
                      <div class="form-group form-float">
                         ...
                         <label class="form-label selectlabel zindex3">Days</label>
                         <input type="text" class="form-control"  name="lump_lower_days" id="lump_lower_days" placeholder="" autocomplete="off" value="<?php if($isLumplower == 'Y'){ echo $bodycontent['AllLumplowerAbdomenData']->lump_lower_days;  } ?>">  
                        </div>
                  ...
                  <div class="row clearfix">
                   ...
                   <div class="col-sm-3">
                     <div class="form-group form-float">
                         <div class="input-group">
                         <label class="form-label selectlabel zindex3">Retanion</label>
                   ...
                   <div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                      <div class="form-group form-float">
                         ...
                         <label class="form-label selectlabel zindex3">Years</label>
                         <input type="text" class="form-control"  name="lump_breast_years" id="lump_breast_years" placeholder="" autocomplete="off" value="<?php if($isLumpInBreast == 'Y'){ echo $bodycontent['AllLumpInBreastData']->lump_breast_years;  } ?>">  
                        </div>
                    ...
                    <div class="col-sm-3">
                      <div class="form-group form-float">
                         ...
                         <label class="form-label selectlabel zindex3">Months</label>
                         <input type="text" class="form-control"  name="lump_breast_months" id="lump_breast_months" placeholder="" autocomplete="off" value="<?php if($isLumpInBreast == 'Y'){ echo $bodycontent['AllLumpInBreastData']->lump_breast_months;  } ?>">  
                        </div>
                      ...
                      <div class="form-group form-float">
                         ...
                         <label class="form-label selectlabel zindex3">Days</label>
                         <input type="text" class="form-control"  name="lump_breast_days" id="lump_breast_days" placeholder="" autocomplete="off" value="<?php if($isLumpInBreast == 'Y'){ echo $bodycontent['AllLumpInBreastData']->lump_breast_days;  } ?>">  
                        </div>
                  ...
                  <div class="row clearfix">
                   ...
                   <div class="col-sm-3">
                      <div class="form-group form-float">
                         ...
                         <label class="form-label selectlabel zindex3">Months</label>
                         <input type="text" class="form-control"  name="breast_congestion_months" id="breast_congestion_months" placeholder="" autocomplete="off" value="<?php if($isbreastcongestion == 'Y'){ echo $bodycontent['AllbreastcongestionData']->breast_congestion_months;  } ?>">  
                        </div>
                   ...
                   <div class="col-sm-3">
                      <div class="form-group form-float">
                         ...
                         <label class="form-label selectlabel zindex3">Days</label>
                         <input type="text" class="form-control"  name="breast_congestion_days" id="breast_congestion_days" placeholder="" autocomplete="off" value="<?php if($isbreastcongestion == 'Y'){ echo $bodycontent['AllbreastcongestionData']->breast_congestion_days;  } ?>">  
                        </div>
