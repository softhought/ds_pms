            ...
            <br>
             ...
             <div class="row clearfix" style="#border: 1px solid red;">
                         ...
                         <div class="form-group form-group searchableDesign">
                            ...
                            <div class="input-group removezindex" id="selmens_medicineerr">
                            <label class="form-label upText selectlabel removezindex">Medicine</label>
                            <div id="selmens_medicinedrp">
                            <select name="selmens_medicine" id="selmens_medicine" class="form-control selpres show-tick removezindex"  data-live-search="true" tabindex="-98">
                            <option value="0"> &nbsp; </option>
                            <?php 
                      ...
                      <div class="col-sm-3">
                          <div class="form-group form-float">
                           <div class="form-line">
                            <input type="text" class="form-control selpres removezindex" name="selmens_medicine_duration" id="selmens_medicine_duration " autocomplete="off" placeholder="" value="" >
                              <label class="form-label upText removezindex">Duration</label>
                           </div>
                           </div>
                      </div>
             ...
             <!-- ------------------------------------------------------------------------------------------------------ -->
                    ...
                    <div class="col-sm-3">
                       <div class="form-group form-float">
                         <div class="input-group " id="cigarette_addictionerr" >
                              <label class="form-label selectlabel" style="top:-17px;">Cigarette Addiction</label> 
                ...
                <div class="row clearfix formrowgap"><!-- start row of LMP -->
                  ...
                  <div class="form-group form-float"> 
                    ...
                    <div class="form-line input-group">
                                  <input type="text" class="form-control datepicker removezindex"  name="lmp_date" id="lmp_date" placeholder="select Date" autocomplete="off" value="<?php 
                ...
                <div class="col-sm-3">
                  <div class="form-group form-float"> 
                  <div class="form-line input-group">
                                 <input type="text" class="form-control removezindex"  name="edd_date" id="edd_date" placeholder=" Date" autocomplete="off" value="<?php 
                ...
                <div class="col-sm-3">
                  <div class="form-group form-float"> 
                          <div class="form-line input-group">
                                    <input type="text" class="form-control datepicker removezindex"  name="seleddbyusg_date" id="seleddbyusg_date" placeholder="select Date" autocomplete="off" value="<?php 
                ...
                <div class="col-sm-2">
                  <div class="form-group form-float"> 
                    <div class="form-line input-group">
                      <input type="text" class="form-control removezindex" name="edd_week" id="edd_week" placeholder="no of week" autocomplete="off" 
                      value="<?php if($bodycontent['antenantalmode']=="EDIT"){
                                  echo $bodycontent['antenantalCaseEditdata']->usg_week;} ?>" 
                                  >
                        <label class="form-label">No. of week</label>          
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-sm-2">
                      <div class="form-group form-float"> 
                          <div class="form-line input-group">
                                <input type="text" class="form-control removezindex" name="edd_days" id="edd_days" placeholder="no of day" autocomplete="off" value="<?php if($bodycontent['antenantalmode']=="EDIT"){
                ...
                <div class="col-sm-3">
                    <div class="form-group form-float"> 
                    <div class="form-line input-group">
                               <input type="text" class="form-control removezindex" name="usg_date" id="usg_date" placeholder="select Date" autocomplete="off" value="<?php 
